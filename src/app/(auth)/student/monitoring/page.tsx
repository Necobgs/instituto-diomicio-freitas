...
const monitoringData: iMonitoring[] = [
    ...
    },
    {
        ...
        termination_date_ieedf: null, // Exemplo de caso sem data de encerramento
    },
    {
        id: 3,
        student: {
    ...
    return (
        ...
        <div className="w-full h-full p-4">
            ...
            <section className="mt-4">
                <DataTable columns={monitoringColumns} data={monitoringData} canEdit={true} canDelete={true}/>
            </section>
