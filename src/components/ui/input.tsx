    ...
    <div className="flex flex-row gap-2 items-center relative">
      <input
        ...
        className={cn(
          ...
          "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive ${type === "password" || (type === "date" && props.placeholder) ? "pr-10" : ""}`,
          className
        )}
        {...props}
      />
